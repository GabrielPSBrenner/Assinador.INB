...
Public Class ExportOptions
    ...
    Public Sub New(ByVal pdfFileName As String, ByVal pdfDoc As PDFWrapper, Optional ByVal password As String = "")
    ...
    Private Sub btOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btOK.Click
        If SaveFileDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            ElseIf filename.EndsWith(".html") And rbHtml.Checked Then
                ...
                mpdfDoc.ExportHtml(filename, nuStart.Value, nuDown.Value, oExport)
