...
Public Class AFPDFLibUtil
    ...
    Public Shared Function Render(ByRef pdfDoc As PDFWrapper) As System.Drawing.Bitmap
        ...
        Return Nothing
    End Function
    Public Shared Sub ExportPDF(ByRef pdfDoc As PDFWrapper, ByVal fileName As String, Optional ByVal startPage As Integer = 1, Optional ByVal endPage As Integer = 0)
        Dim oExport = New ExportHtmlParams()
        ...
        If Not Nothing Is pdfDoc Then
            ...
            Try
                ...
                ElseIf fileName.EndsWith(".html") Then
                    oExport.ComplexMode = True
                    oExport.EncodeName = "UTF-8"
                    oExport.HtmlLinks = True

                    pdfDoc.ExportHtml(fileName, startPage, endPage, oExport)
                End If
            Catch ex As Exception
    ...
    Public Shared Function FillTree(ByRef tvwOutline As TreeView, ByRef pdfDoc As PDFWrapper) As Boolean
        FillTree = False
        tvwOutline.Nodes.Clear()
        For Each ol As OutlineItem In pdfDoc.Outline
            FillTree = True
    ...
    Public Shared Sub FillTreeRecursive(ByVal olParent As OutlineItemCollection(Of OutlineItem), ByVal treeNode As TreeNode)
        For Each ol As OutlineItem In olParent
            Dim tn As New TreeNode(ol.Title)
            tn.Tag = ol
    ...
    Public Shared Function BuildJavaScriptArray(ByRef pdfDoc As PDFWrapper) As String
    ...
    Public Shared Function BuildHTMLBookmarks(ByRef pdfDoc As PDFWrapper) As String
...
StartPageList:
    ...
    Public Shared Sub FillHTMLTreeRecursive(ByVal olParent As OutlineItemCollection(Of OutlineItem), ByRef htmlString As String, ByRef pdfDoc As PDFWrapper)
        htmlString &= "<ul>"
        For Each ol As OutlineItem In olParent
...
Public Class PDFOutline
    ...
    Public Item As OutlineItem
    Friend _doc As PDFWrapper = Nothing
    ...
    Friend Sub New(ByVal title__1 As String, ByVal outlineItem As OutlineItem, ByVal doc As PDFWrapper)
        Title = title__1
        Item = outlineItem
        _doc = doc
    End Sub
